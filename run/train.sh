...
nohup python3 -m torch.distributed.launch --nproc_per_node=$NUM_PROC --master_port=29551 ./DeepGate3-Transformer/src/train_dg3.py \
 --exp_id train_plain_${DATA_RATIO}p_unfix \
 --data_dir /home/zyzheng23/project/data/inmemory/dg3_train_${DATA_RATIO}p \
 --npz_dir /home/zyzheng23/project/dg3_dataset/${DATA_RATIO}p \
 --pretrained_model_path ./DeepGate3-Transformer/trained/model_last_workload.pth \
 --tf_arch plain --lr 1e-4 \
 --workload --gpus ${GPUS} --batch_size 128 \
 >> /home/zyzheng23/project/DeepGate3-Transformer/exp/0426_plain_workload_${DATA_RATIO}p_balanced_unfreeze.log 2>&1 &
