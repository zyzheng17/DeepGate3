...
nohup python3 -m torch.distributed.launch --nproc_per_node=$NUM_PROC --master_port=29557 ./DeepGate3-Transformer/src/train_dg3.py \
 ...
 --data_dir /home/zyzheng23/project/data/inmemory/dg3_train_baseline_${DATA_RATIO}p \
 ...
 --tf_arch baseline --lr 1e-4 \
 --workload --gpus ${GPUS} --batch_size 128 \
 >> /home/zyzheng23/project/DeepGate3-Transformer/exp/0422_baseline_workload_${DATA_RATIO}p_balanced_unfixed.log 2>&1 &
